...
export function IniSettings({ onRestart }: Props) {
  ...
  function renderField(key: string) {
    ...
    const isBool = val === "true" || val === "false" || key === "Public" || key === "Open" || key === "UPnP" || key === "PVP" || key === "PauseEmpty" || key === "GlobalChat";
    ...
    const multiline = val.length > 80 || key.includes("Message") || key.includes("Description");
    return (
  ...
  return (
    <div className="page">
      ...
      <p className="sub">
        {path || "Loading…"} — comments are preserved on save.
      </p>
